				...
				<table class="table">
					...
					<tr>
						<td align="center">
							...
							<?php
								$arrFields = array('', 'submitlog', 'paddata', 'customurls', 'bannerlist', 'blacklist', 'usrreviews');
								$arrFieldCaptions = array('All tables', 'PAD Submissions', 'Search PAD Data', 'Custom URLs', 'Banners', 'Black List', 'User Reviews');
