<?php
	...
	$schema = array(   
		'submitlog' => array(   
			'submid' => array('appgini' => 'INT(6) not null primary key auto_increment '),
			'cstatus' => array('appgini' => 'TINYINT(1) default \'0\' '),
			'logtime' => array('appgini' => 'DATETIME '),
			'ipaddr' => array('appgini' => 'VARCHAR(20) '),
			'company' => array('appgini' => 'VARCHAR(50) '),
			'country' => array('appgini' => 'VARCHAR(50) '),
			'website' => array('appgini' => 'VARCHAR(128) '),
			'contactname' => array('appgini' => 'VARCHAR(60) '),
			'email' => array('appgini' => 'VARCHAR(50) '),
			'title' => array('appgini' => 'VARCHAR(50) '),
			'version' => array('appgini' => 'VARCHAR(15) '),
			'pdate' => array('appgini' => 'DATE '),
			'cost' => array('appgini' => 'FLOAT(1,0) '),
			'ptype' => array('appgini' => 'VARCHAR(15) '),
			'install' => array('appgini' => 'VARCHAR(50) '),
			'os' => array('appgini' => 'VARCHAR(200) '),
			'languages' => array('appgini' => 'VARCHAR(255) '),
			'changeinfo' => array('appgini' => 'TEXT '),
			'category' => array('appgini' => 'VARCHAR(80) '),
			'requirements' => array('appgini' => 'VARCHAR(200) '),
			'ksize' => array('appgini' => 'INT(11) '),
			'keywords' => array('appgini' => 'VARCHAR(255) '),
			'description' => array('appgini' => 'VARCHAR(84) '),
			'descrlarge' => array('appgini' => 'TEXT '),
			'homepage' => array('appgini' => 'VARCHAR(128) '),
			'screenshot' => array('appgini' => 'VARCHAR(128) '),
			'icon' => array('appgini' => 'VARCHAR(128) '),
			'padfile' => array('appgini' => 'VARCHAR(128) '),
			'download' => array('appgini' => 'VARCHAR(128) '),
			'aspnumber' => array('appgini' => 'VARCHAR(5) '),
			'backlink' => array('appgini' => 'VARCHAR(128) '),
			'affiliate' => array('appgini' => 'INT(12) '),
			'affiliateid' => array('appgini' => 'VARCHAR(15) ')
		),
		'paddata' => array(   
			'progid' => array('appgini' => 'INT(6) not null primary key auto_increment '),
			'company' => array('appgini' => 'VARCHAR(50) '),
			'country' => array('appgini' => 'VARCHAR(50) '),
			'website' => array('appgini' => 'VARCHAR(128) '),
			'contactname' => array('appgini' => 'VARCHAR(60) '),
			...
			'cost' => array('appgini' => 'FLOAT(1,0) '),
			'ptype' => array('appgini' => 'VARCHAR(15) '),
			'status' => array('appgini' => 'TINYINT(1) default \'0\' '),
			'install' => array('appgini' => 'VARCHAR(50) '),
			'os' => array('appgini' => 'VARCHAR(200) '),
			'languages' => array('appgini' => 'VARCHAR(255) '),
			'changeinfo' => array('appgini' => 'TEXT '),
			...
			'padfile' => array('appgini' => 'VARCHAR(128) '),
			'download' => array('appgini' => 'VARCHAR(128) '),
			'dlcount' => array('appgini' => 'INT(11) default \'0\' '),
			'dlipaddr' => array('appgini' => 'VARCHAR(20) '),
			'aspnumber' => array('appgini' => 'VARCHAR(5) '),
			'affiliate' => array('appgini' => 'VARCHAR(40) '),
			'affiliateid' => array('appgini' => 'VARCHAR(15) '),
			'siterating' => array('appgini' => 'TINYINT(1) default \'0\' '),
			'clean' => array('appgini' => 'TINYINT(1) default \'0\' '),
			'paderrcount' => array('appgini' => 'INT(11) default \'0\' ')
		),
		'customurls' => array(   
			'customid' => array('appgini' => 'INT(6) not null primary key auto_increment '),
			'progid' => array('appgini' => 'INT(6) default \'0\' '),
			'customurl' => array('appgini' => 'VARCHAR(200) ')
		),
		'bannerlist' => array(   
			'bannerid' => array('appgini' => 'INT(6) not null primary key auto_increment '),
			'imgurl' => array('appgini' => 'VARCHAR(128) '),
			'linkurl' => array('appgini' => 'VARCHAR(128) '),
			'listdisp' => array('appgini' => 'TINYINT(1) '),
			'dldisp' => array('appgini' => 'TINYINT(1) '),
			'authdisp' => array('appgini' => 'TINYINT(1) ')
		),
		'blacklist' => array(   
			'blackid' => array('appgini' => 'INT(6) not null primary key auto_increment '),
			'bldomain' => array('appgini' => 'VARCHAR(100) ')
		),
		'usrreviews' => array(   
			'revid' => array('appgini' => 'INT(6) not null primary key auto_increment '),
			'progid' => array('appgini' => 'INT(6) default \'0\' '),
			'useripaddr' => array('appgini' => 'VARCHAR(20) '),
			'revtime' => array('appgini' => 'DATETIME '),
			'username' => array('appgini' => 'VARCHAR(50) '),
			'userrating' => array('appgini' => 'INT(1) default \'0\' '),
			'usercomment' => array('appgini' => 'TEXT ')
		)
	);
