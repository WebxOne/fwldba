<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'paddata' table. 
	...
	*/
	...
	function paddata_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function paddata_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function paddata_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['company'], $data['country'], $data['website'], $data['contactname'], $data['email'], $data['title'], $data['version'], $data['pdate'], $data['cost'], $data['ptype'], $data['status'], $data['install'], $data['os'], $data['languages'], $data['changeinfo'], $data['category'], $data['requirements'], $data['ksize'], $data['keywords'], $data['description'], $data['descrlarge'], $data['homepage'], $data['screenshot'], $data['icon'], $data['padfile'], $data['download'], $data['dlcount'], $data['dlipaddr'], $data['aspnumber'], $data['affiliate'], $data['affiliateid'], $data['siterating'], $data['clean'], $data['paderrcount']
	...
	*/
	...
	function paddata_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function paddata_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['progid'], $data['company'], $data['country'], $data['website'], $data['contactname'], $data['email'], $data['title'], $data['version'], $data['pdate'], $data['cost'], $data['ptype'], $data['status'], $data['install'], $data['os'], $data['languages'], $data['changeinfo'], $data['category'], $data['requirements'], $data['ksize'], $data['keywords'], $data['description'], $data['descrlarge'], $data['homepage'], $data['screenshot'], $data['icon'], $data['padfile'], $data['download'], $data['dlcount'], $data['dlipaddr'], $data['aspnumber'], $data['affiliate'], $data['affiliateid'], $data['siterating'], $data['clean'], $data['paderrcount']
	...
	*/
	...
	function paddata_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function paddata_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function paddata_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function paddata_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function paddata_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function paddata_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function paddata_batch_actions(&$args){
