<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'submitlog' table. 
	...
	*/
	...
	function submitlog_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function submitlog_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function submitlog_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['cstatus'], $data['logtime'], $data['ipaddr'], $data['company'], $data['country'], $data['website'], $data['contactname'], $data['email'], $data['title'], $data['version'], $data['pdate'], $data['cost'], $data['ptype'], $data['install'], $data['os'], $data['languages'], $data['changeinfo'], $data['category'], $data['requirements'], $data['ksize'], $data['keywords'], $data['description'], $data['descrlarge'], $data['homepage'], $data['screenshot'], $data['icon'], $data['padfile'], $data['download'], $data['aspnumber'], $data['backlink'], $data['affiliate'], $data['affiliateid']
	...
	*/
	...
	function submitlog_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function submitlog_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function submitlog_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['submid'], $data['cstatus'], $data['logtime'], $data['ipaddr'], $data['company'], $data['country'], $data['website'], $data['contactname'], $data['email'], $data['title'], $data['version'], $data['pdate'], $data['cost'], $data['ptype'], $data['install'], $data['os'], $data['languages'], $data['changeinfo'], $data['category'], $data['requirements'], $data['ksize'], $data['keywords'], $data['description'], $data['descrlarge'], $data['homepage'], $data['screenshot'], $data['icon'], $data['padfile'], $data['download'], $data['aspnumber'], $data['backlink'], $data['affiliate'], $data['affiliateid']
	...
	*/
	...
	function submitlog_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function submitlog_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function submitlog_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function submitlog_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function submitlog_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function submitlog_batch_actions(&$args){
