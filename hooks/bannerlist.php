<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'bannerlist' table. 
	...
	*/
	...
	function bannerlist_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function bannerlist_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function bannerlist_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['imgurl'], $data['linkurl'], $data['listdisp'], $data['dldisp'], $data['authdisp']
	...
	*/
	...
	function bannerlist_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function bannerlist_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['bannerid'], $data['imgurl'], $data['linkurl'], $data['listdisp'], $data['dldisp'], $data['authdisp']
	...
	*/
	...
	function bannerlist_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function bannerlist_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function bannerlist_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function bannerlist_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function bannerlist_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function bannerlist_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function bannerlist_batch_actions(&$args){
