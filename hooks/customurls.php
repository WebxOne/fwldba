<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'customurls' table. 
	...
	*/
	...
	function customurls_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function customurls_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function customurls_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function customurls_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function customurls_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['customid'], $data['progid'], $data['customurl']
	...
	*/
	...
	function customurls_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function customurls_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function customurls_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function customurls_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function customurls_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function customurls_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function customurls_batch_actions(&$args){
