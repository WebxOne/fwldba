<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'usrreviews' table. 
	...
	*/
	...
	function usrreviews_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function usrreviews_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function usrreviews_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['progid'], $data['useripaddr'], $data['revtime'], $data['username'], $data['userrating'], $data['usercomment']
	...
	*/
	...
	function usrreviews_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function usrreviews_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['revid'], $data['progid'], $data['useripaddr'], $data['revtime'], $data['username'], $data['userrating'], $data['usercomment']
	...
	*/
	...
	function usrreviews_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function usrreviews_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function usrreviews_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function usrreviews_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function usrreviews_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function usrreviews_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function usrreviews_batch_actions(&$args){
