...
function submitlog_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function paddata_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function customurls_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function bannerlist_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
...
function usrreviews_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
